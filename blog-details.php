          ...
          <div class="col-lg-8">
            ...
            ?>
              <article class="blog-details">
                ...
                <h2 class="title"><?php echo $d['judul'] ?></h2>

                <div class="meta-top">
                  <ul>
                    <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="blog-details.php"><?php echo $d['penulis'] ?></a></li>
                  </ul>
                </div><!-- End meta top -->
                ...
                <div class="meta-bottom">
                  ...
                  <ul class="cats">
                    <li><a href="#"><?php echo $d['kategori'] ?></a></li>
                  </ul>
